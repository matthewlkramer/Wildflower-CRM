...
import givingRelationshipsRouter from "./givingRelationships";
import emailsRouter from "./emails";
import phoneNumbersRouter from "./phoneNumbers";
import addressesRouter from "./addresses";
import opportunitiesRouter from "./opportunitiesAndPledges";
import opportunityCommitmentsRouter from "./opportunityCommitments";
import fundraisingRecordActionsRouter from "./fundraisingRecordActions";
import pledgeAllocationsRouter from "./pledgeAllocations";
import pledgeExpectedPaymentsRouter from "./pledgeExpectedPayments";
import grantTermsRouter from "./grantTerms";
...
import wildflowerUpdateItemsRouter from "./wildflowerUpdateItems";
...
import restrictionTextReviewRouter from "./restrictionTextReview";
...
router.use(givingRelationshipsRouter);
router.use(emailsRouter);
router.use(phoneNumbersRouter);
router.use(addressesRouter);
router.use(opportunityCommitmentsRouter);
router.use(fundraisingRecordActionsRouter);
router.use(opportunitiesRouter);
router.use(pledgeAllocationsRouter);
router.use(pledgeExpectedPaymentsRouter);
router.use(grantTermsRouter);
...
router.use(wildflowerUpdateItemsRouter);
...
router.use(restrictionTextReviewRouter);
