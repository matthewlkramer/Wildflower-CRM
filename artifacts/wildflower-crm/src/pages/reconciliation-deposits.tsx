...
export default function ReconciliationDepositsPage() {
  ...
  const handleAttachPaymentUnit = async (
    candidate: DepositCandidatePaymentUnit,
  ) => {
  ...
  const handleRemoveManualComponent = async () => {
    ...
    toast({
      title: "Manual component removed",
      description: "The unexplained remainder has been reopened.",
    });
    invalidate();
  };
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {knownPaymentFor
                ...
                : "the"}{" "}
              unexplained remainder by attaching an unclaimed payment unit or
              creating a new one.
            </AlertDialogDescription>
          </AlertDialogHeader>
              ...
              <div className="max-h-64 space-y-2 overflow-y-auto">
                {candidatePaymentUnits.isLoading ? (
                  <p className="text-sm text-muted-foreground">
                    Searching unclaimed payment units…
                  </p>
                  ...
                  candidatePaymentUnits.data.data.map((candidate) => (
                    <button
                      key={candidate.id}
                      type="button"
                    ...
                    >
                      <span className="min-w-0">
                        ...
                        <span className="block text-xs text-muted-foreground">
                          ...
                          {candidate.receivedDate ?? "undated"} · {candidate.id}
                        </span>
                      </span>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Remove {manualComponentFor?.label ?? "this component"} and reopen
              the unexplained remainder. Gifts and payment applications are not
              changed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
