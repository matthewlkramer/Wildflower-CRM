          ...
          {selected ? (
            <>
              ...
              <div className="space-y-5">
                  ...
                  {selected.screenshotStatus === "captured" &&
                  selected.screenshotUrl ? (
                    <section>
                      ...
                      <a
                        className="mt-3 block overflow-hidden rounded-lg border bg-muted/20"
                      ...
                      >
                        <img
                          ...
                          alt="Screenshot captured with feedback"
                          className="max-h-[32rem] w-full object-contain"
                        />
                      </a>
                    </section>
                  ) : selected.screenshotStatus === "failed" ? (
                    <section className="rounded-lg border border-destructive/30 bg-destructive/5 p-3 text-sm">
                      <h3 className="font-semibold">Screenshot capture failed</h3>
                      <p className="mt-1 text-muted-foreground">
                        {selected.screenshotError ??
                          "No screenshot was saved with this feedback."}
                      </p>
                    </section>
                  ) : selected.screenshotStatus === "captured" ? (
                    <section className="rounded-lg bg-muted/40 p-3 text-sm text-muted-foreground">
                      <h3 className="font-semibold text-foreground">
                        Screenshot pending
                      </h3>
                      <p className="mt-1">
                        The screenshot was captured but is not available in
                        storage yet.
                      </p>
                    </section>
                  ) : null}
