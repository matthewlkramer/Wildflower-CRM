...
const navItems: NavEntry[] = [
  ...
  {
    href: "/payment-intermediaries",
    label: "Payment Intermediaries",
    icon: Landmark,
  },
  {
    href: "/fundable-projects",
  ...
  {
    href: "/grants-calendar",
    label: "Application/Close Deadlines",
    icon: CalendarDays,
  },
  ...
  {
    href: "/fiscal-year-report/current",
    label: "FY Report",
    icon: FileBarChart,
  },
  {
    href: "/reporting-deadlines",
  ...
  {
    href: "/admin/future-functionality",
    label: "Future functionality possibilities",
    icon: Lightbulb,
    adminOnly: true,
  },
  ...
  {
    href: "/restriction-text-review",
    label: "Restriction Text Review",
    icon: ListChecks,
    adminOnly: true,
  },
];
      ...
      {navItems
        ...
        .map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`h-4 w-4 shrink-0 transition-transform duration-150 ${isActive ? "scale-110" : "group-hover:scale-110"}`}
              />
      ...
      <SidebarCollapsedContext.Provider value={collapsed}>
        <div className="flex min-h-screen bg-background">
          ...
          >
            ...
            <div
              className={`border-t border-sidebar-border ${collapsed ? "p-2" : "p-4"}`}
            >
              {collapsed ? (
            ...
            <header className="flex h-14 items-center justify-between gap-2 border-b bg-background px-3 shadow-sm z-10">
              ...
              <div className="flex items-center gap-2">
                <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
                  ...
                  <SheetContent
                    side="left"
                    className="flex w-72 flex-col gap-0 p-0 bg-sidebar border-r-sidebar-border text-sidebar-foreground"
                  >
