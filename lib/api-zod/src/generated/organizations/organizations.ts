...
export const ListOrganizationsResponse = zod.object({
  ...
  "priority": zod.enum(['top', 'high', 'medium', 'low']).describe('Manual overall assessment of the strongest prospects for future giving, considering capacity, connection, enthusiasm, and organizational fit. Blank means not assessed.').nullish().describe('Solicitation priority tier (top\/high\/medium\/low).'),
