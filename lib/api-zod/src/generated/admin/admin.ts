...
export const AdminListQuickbooksRulesResponseItem = zod.object({
  ...
  "exclusionReason": zod.enum(['zero_amount', 'loan', 'membership', 'interest', 'government_reimbursement', 'tax_refund', 'other_revenue', 'earned_income', 'fiscally_sponsored', 'intercompany_transfer', 'other', 'insurance', 'expense_refund', 'expensify', 'returned_wire']).nullish().describe('Required when action=exclude.'),
