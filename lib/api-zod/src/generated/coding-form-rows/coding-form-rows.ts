...
export const ListCodingFormRowsResponse = zod.object({
  ...
  "attribute": zod.enum(['reportDeadline', 'restrictionDescription', 'purposeVerbatim', 'otherRestriction', 'timeRestriction', 'intendedUsage', 'regionalRestriction', 'allocationEntity', 'address', 'circle', 'seriesType', 'additionalNotes', 'internalMemo']).describe('Which importable attribute this row describes. restrictionDescription = plain-language summary; purposeVerbatim = exact source language; otherRestriction \/ timeRestriction = restriction axes.'),
