...
export const ListPeopleQueryParams = zod.object({
  ...
  "conferenceTypeId": zod.coerce.string().optional().describe('People who attended any event of this conference type.'),
  "conferenceEventId": zod.coerce.string().optional().describe('People who attended this specific conference event.'),
...
export const ListPeopleResponse = zod.object({
  ...
  "primaryHouseholdId": zod.string().nullish().describe('The one current household used by automatic donor-of-record routing and related-giving views.'),
  ...
  "activeOrganizationIds": zod.array(zod.string()).nullish().describe('IDs of organizations the person currently holds a role at (people_entity_roles.current=\'current\'). Used to group related priority records without relying on organization-name matching.'),
...
export const CreatePersonBody = zod.object({
  ...
  "primaryHouseholdId": zod.string().optional(),
...
export const UpdatePersonBody = zod.object({
  ...
  "deceased": zod.boolean().optional(),
  "currentHomeRegionId": zod.string().nullish(),
  "primaryHouseholdId": zod.string().nullish(),
  "details": zod.string().nullish(),
  "ownerUserId": zod.string().nullish(),
  "tags": zod.string().nullish(),
  "lastContacted": zod.string().date().nullish(),
...
export const getPersonRelationshipSummaryQueryMeetingPreparationDefault = false;

export const GetPersonRelationshipSummaryQueryParams = zod.object({
  "meetingPreparation": zod.coerce.boolean().default(getPersonRelationshipSummaryQueryMeetingPreparationDefault).describe('Include meeting-only school and Wildflower update context.')
})
