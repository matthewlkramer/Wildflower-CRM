...
export const ListWorkbenchClustersResponse = zod.object({
  ...
  "refundTotal": zod.string().nullish().describe('Σ |refund amounts| settling inside a payout, major units. Null for QB\/crm_only clusters.'),
  "adjustmentTotal": zod.string().nullish().describe('Net of adjustment-type balance txns settling inside a payout (fee refunds, failed-payment reversals, failed-payout recoveries), major units. Null for QB\/crm_only clusters and payouts not yet re-synced.'),
