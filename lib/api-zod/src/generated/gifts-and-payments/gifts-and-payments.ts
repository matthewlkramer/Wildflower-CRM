...
export const ListGiftsAndPaymentsQueryParams = zod.object({
  ...
  "unlinkedToPaymentUnit": zod.coerce.boolean().optional().describe('When true, list only gifts with no canonical `payment_units.gift_id` owner. This powers Browse unlinked CRM gifts and is intentionally independent of QuickBooks tie status: a gift linked to bank or Stripe payment evidence but still missing downstream QBO documentation is linked and must not appear here.'),
...
export const ListGiftsAndPaymentsResponse = zod.object({
  ...
  "hasPaymentEvidence": zod.boolean().optional().describe('True when any canonical payment unit currently points to this gift. Broad reconciliation searches keep such gifts visible and label them as already linked, while Browse unlinked CRM gifts excludes them. This is independent of whether downstream QuickBooks documentation is present.'),
  ...
  "tags": zod.string().nullish().describe('Comma-separated free-text tags. Historical records may contain prefixed legacy coding-form reference attributes (circle, series, notes, memo).'),
