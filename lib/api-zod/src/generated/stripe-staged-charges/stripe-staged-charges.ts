...
export const CreateGiftFromStripeStagedChargeBody = zod.object({
  ...
  "opportunityId": zod.string().nullish().describe('Record this charge\'s GROSS as the received gift produced by an opportunity or as a payment on a finalized pledge. The donor derives from the selected record, the gift links through gift.opportunityId, and allocations seed from its plan. The record must be active (not archived\/lost\/dormant). It is classified as a pledge payment only when pledgeCommittedAt was already set.')
