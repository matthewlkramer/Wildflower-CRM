...
export const ListFinancialCorrectionsQueryParams = zod.object({
  limit: zod.coerce
    .number()
    .min(1)
    .max(listFinancialCorrectionsQueryLimitMax)
    .default(listFinancialCorrectionsQueryLimitDefault)
...
export const ListFinancialCorrectionsResponse = zod.object({
  corrections: zod.array(
    zod.object({
      kind: zod
        .enum(["merge_gifts", "link_evidence"])
        .describe(
      ...
      reason: zod
        .string()
        .describe("Human-readable explanation of why this was flagged."),
      gifts: zod.array(
        zod.object({
          id: zod.string(),
          donorName: zod
          ...
          amount: zod
            .string()
            .nullable()
            .describe("Gift gross amount (numeric string)."),
          date: zod
            .string()
            .nullish()
            .describe("Date the gift was received (ISO date)."),
          allocationCount: zod
            .number()
            .describe("Number of allocation lines on the gift."),
          pledgeId: zod
            .string()
            .nullish()
            .describe("Pledge this gift pays toward, if any."),
        }),
      ),
      evidence: zod
        .object({
          kind: zod
            .enum(["qb_staged", "stripe_charge"])
            .describe("Which evidence source this row comes from."),
          id: zod
            .string()
            .describe(
          ...
          amount: zod
            .string()
            .nullish()
            .describe("Evidence amount (numeric string)."),
          ...
          entityName: zod
            .string()
            .nullish()
            .describe("Attributed fund entity, when known."),
        })
        .optional(),
      mergeSuggestion: zod
        .object({
 ...
 */
export const DismissFinancialCorrectionBody = zod
  .object({
...
export const ApplyFinancialCorrectionBody = zod
  .object({
...
export const ListCleanupQueueQueryParams = zod.object({
  status: zod
    ...
    .optional()
    .describe("Filter by status. Omit to get open items only."),
  limit: zod.coerce
    .number()
    .min(1)
    .max(listCleanupQueueQueryLimitMax)
    .default(listCleanupQueueQueryLimitDefault),
  ...
  data: zod.array(
    zod.object({
      ...
      targetName: zod
        .string()
        .nullish()
        .describe("Resolved display name of the target record (when known)."),
      reasonCode: zod
        .string()
        .describe("Machine-readable category of the flag."),
      note: zod.string().describe("Human-readable description of what to fix."),
      status: zod.enum(["open", "resolved", "dismissed"]),
      flaggedAt: zod
        .string()
        .describe("ISO timestamp the record was flagged for cleanup."),
      resolvedAt: zod
        .string()
        .nullish()
        .describe("ISO timestamp the item was resolved or dismissed."),
      resolvedByUserId: zod.string().nullish(),
      resolvedByUserName: zod
        .string()
        .nullish()
        .describe("Display name of the user who resolved\/dismissed the item."),
            ...
            donorbox: zod
              .object({
                ...
                donationType: zod
                  .string()
                  .nullish()
                  .describe("Donorbox payment instrument (e.g. stripe)."),
                amount: zod.string().nullish(),
...
export const ListStripeStagedChargesResponse = zod.object({
  data: zod.array(
    zod.object({
      ...
      refundPropagationStatus: zod
        .enum(["none", "proposed", "applied", "dismissed"])
        .describe(
...
export const GetStripeStagedChargesSummaryResponse = zod
  .object({
...
export const ListDonorboxReviewQueryParams = zod.object({
  queue: zod
    .enum(["needs_review", "done", "excluded"])
    .optional()
    .describe("Which worklist bucket to list (default needs_review)."),
  search: zod.coerce
    .string()
    .optional()
    .describe(
  ...
  limit: zod.coerce
    .number()
    .min(1)
    .max(listDonorboxReviewQueryLimitMax)
    .default(listDonorboxReviewQueryLimitDefault),
  ...
  data: zod.array(
    zod
      .object({
        ...
        exclusionReason: zod
          .enum(["already_booked", "duplicate", "not_a_gift", "other"])
          .describe(
        ...
        createdGiftId: zod
          .string()
          .nullish()
          .describe("Set when a NEW gift was minted from this donation."),
        organizationName: zod.string().nullish(),
        householdName: zod.string().nullish(),
        individualGiverPersonName: zod.string().nullish(),
        intermediaryName: zod.string().nullish(),
...
export const LinkDonorboxDonationToGiftResponse = zod
  .object({
    id: zod.string().describe("Donorbox donation id (primary key)."),
    donationType: zod
      .string()
    ...
    matchedGiftId: zod
      .string()
      .nullish()
      .describe("Set when linked to a PRE-EXISTING gift (no new ledger row)."),
    createdGiftId: zod
      .string()
      .nullish()
      .describe("Set when a NEW gift was minted from this donation."),
...
export const CreateGiftFromDonorboxDonationBody = zod
  .object({
    organizationId: zod.string().nullish(),
    individualGiverPersonId: zod.string().nullish(),
    householdId: zod.string().nullish(),
...
export const ExcludeDonorboxDonationResponse = zod
  .object({
    id: zod.string().describe("Donorbox donation id (primary key)."),
    donationType: zod
      .string()
...
export const ReIncludeDonorboxDonationResponse = zod
  .object({
    id: zod.string().describe("Donorbox donation id (primary key)."),
    donationType: zod
      .string()
