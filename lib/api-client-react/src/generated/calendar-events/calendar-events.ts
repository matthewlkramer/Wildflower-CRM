...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const getDismissCalendarEventNotesUrl = (id: string,) => {




  return `/api/calendar-events/${id}/no-notes`
}

export const dismissCalendarEventNotes = async (id: string, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDismissCalendarEventNotesUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getDismissCalendarEventNotesMutationOptions = <TError = ErrorType<NotFoundResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof dismissCalendarEventNotes>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof dismissCalendarEventNotes>>, TError,{id: string}, TContext> => {

const mutationKey = ['dismissCalendarEventNotes'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof dismissCalendarEventNotes>>, {id: string}> = (props) => {
          const {id} = props ?? {};

          return  dismissCalendarEventNotes(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DismissCalendarEventNotesMutationResult = NonNullable<Awaited<ReturnType<typeof dismissCalendarEventNotes>>>

    export type DismissCalendarEventNotesMutationError = ErrorType<NotFoundResponse>

    export const useDismissCalendarEventNotes = <TError = ErrorType<NotFoundResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof dismissCalendarEventNotes>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof dismissCalendarEventNotes>>,
        TError,
        {id: string},
        TContext
      > => {
      return useMutation(getDismissCalendarEventNotesMutationOptions(options));
    }
