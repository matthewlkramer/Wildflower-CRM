...
export const rejectStripeStagedCharge = async (id: string, options?: RequestInit): Promise<StripeStagedCharge> => {
...
export const getRejectStripeStagedChargeMutationOptions = <TError = ErrorType<NotFoundResponse | void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rejectStripeStagedCharge>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof rejectStripeStagedCharge>>, TError,{id: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof rejectStripeStagedCharge>>, {id: string}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RejectStripeStagedChargeMutationResult = NonNullable<Awaited<ReturnType<typeof rejectStripeStagedCharge>>>
    
    export type RejectStripeStagedChargeMutationError = ErrorType<NotFoundResponse | void>

    /**
 * @summary Reject a Stripe charge (retained so re-sync won't re-stage it).
 */
export const useRejectStripeStagedCharge = <TError = ErrorType<NotFoundResponse | void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rejectStripeStagedCharge>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
