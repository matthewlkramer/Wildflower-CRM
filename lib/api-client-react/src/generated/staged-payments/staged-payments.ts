...
export const setStagedPaymentNeedsResearch = async (id: string,
    setStagedPaymentNeedsResearchBody: SetStagedPaymentNeedsResearchBody, options?: RequestInit): Promise<StagedPayment> => {
...
export const getSetStagedPaymentNeedsResearchMutationOptions = <TError = ErrorType<BadRequestResponse | NotFoundResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setStagedPaymentNeedsResearch>>, TError,{id: string;data: BodyType<SetStagedPaymentNeedsResearchBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof setStagedPaymentNeedsResearch>>, TError,{id: string;data: BodyType<SetStagedPaymentNeedsResearchBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setStagedPaymentNeedsResearch>>, {id: string;data: BodyType<SetStagedPaymentNeedsResearchBody>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SetStagedPaymentNeedsResearchMutationResult = NonNullable<Awaited<ReturnType<typeof setStagedPaymentNeedsResearch>>>
    export type SetStagedPaymentNeedsResearchMutationBody = BodyType<SetStagedPaymentNeedsResearchBody>
    export type SetStagedPaymentNeedsResearchMutationError = ErrorType<BadRequestResponse | NotFoundResponse>

    /**
 * @summary Set or clear the plain human "needs research" flag on a staged payment.
 */
export const useSetStagedPaymentNeedsResearch = <TError = ErrorType<BadRequestResponse | NotFoundResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setStagedPaymentNeedsResearch>>, TError,{id: string;data: BodyType<SetStagedPaymentNeedsResearchBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
