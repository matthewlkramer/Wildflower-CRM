 ...
 */
export const getListPotentialDuplicatesUrl = (params: ListPotentialDuplicatesParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/potential-duplicates?${stringifiedParams}` : `/api/potential-duplicates`
}
...
export const getListPotentialDuplicatesQueryKey = (params?: ListPotentialDuplicatesParams,) => {
    return [
    `/api/potential-duplicates`, ...(params ? [params] : [])
    ] as const;
    }
...
export type ListPotentialDuplicatesQueryResult = NonNullable<Awaited<ReturnType<typeof listPotentialDuplicates>>>
...
export const getDismissPotentialDuplicateMutationOptions = <TError = ErrorType<BadRequestResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof dismissPotentialDuplicate>>, TError,{data: BodyType<DismissDuplicateBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof dismissPotentialDuplicate>>, TError,{data: BodyType<DismissDuplicateBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DismissPotentialDuplicateMutationResult = NonNullable<Awaited<ReturnType<typeof dismissPotentialDuplicate>>>
    export type DismissPotentialDuplicateMutationBody = BodyType<DismissDuplicateBody>
    export type DismissPotentialDuplicateMutationError = ErrorType<BadRequestResponse | ForbiddenResponse>

    /**
 * @summary Admin-only. Mark a pair as "not a duplicate" so the detector never re-surfaces it. Idempotent — dismissing the same pair twice is a no-op.
 */
export const useDismissPotentialDuplicate = <TError = ErrorType<BadRequestResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof dismissPotentialDuplicate>>, TError,{data: BodyType<DismissDuplicateBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
